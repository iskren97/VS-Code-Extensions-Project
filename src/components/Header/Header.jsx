      ...
      <Grid className="header-container" container>
        ...
        <div className="header-buttons-container">
          {loadingIndicator ? (
            ...
            <>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                {userData.role !== 'blocked' ? (
                  <NavLink to="/upload">
                    <Button variant="contained" startIcon={<CloudUploadIcon />} sx={headerButton}>
                      Upload
                    </Button>
                  </NavLink>
                ) : (
            ...
            <>
              <NavLink to="/register">
                <Button variant="contained" startIcon={<VpnKeyIcon />} sx={headerButton}>
                  {' '}
                  Sign Up{' '}
                </Button>
              </NavLink>
              ...
              <NavLink to="/login">
                <Button variant="contained" startIcon={<LoginIcon />} sx={headerButton}>
                  {' '}
                  Sign In{' '}
                </Button>
              </NavLink>
